...
def get_msg_file_info(msg):
    if not msg:
        return None
    if msg.video:
        return {"size": msg.video.size or 0, "mime": msg.video.mime_type or "video/mp4",
                "duration": msg.video.duration or 0, "thumbs": msg.video.thumbs}
    if msg.document:
        return {"size": msg.document.size or 0, "mime": msg.document.mime_type or "video/mp4",
                "duration": 0, "thumbs": msg.document.thumbs}
    return None
